                                                            ...
                                                            <div class="col-sm-6">
                                                                <ul class="t-list d-flex justify-content-center justify-content-sm-end">
                                                                    <li class="t-list__item">
                                                                        <a href="<%=BOOK_ADD_URL%>" class="btn btn-transparent btn-primary sm-text text-uppercase">新增图书</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <table class=" t-mb-30 table table-bordered t-text-dark--light-15 sm-text">
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th scope="col" class="text-center">图书名称</th>
                                                                                <th scope="col" class="text-center">出版机构</th>
                                                                                            ...
                                                                                            <li class="t-list__item">
                                                                                                <a href="#" class="t-link t-link--alpha">
                                                                                                    <span class="d-flex align-items-center">
                                                                                                        ...
                                                                                                        <a href="<%=BOOK_EDIT_URL%>?bid=${book.bid}" class="text-capitalize">图书编辑</a>
                                                                                                    </span>
                                                                                                </a>
                                                                                            </li>
                                                                                            <li class="t-list__item">
